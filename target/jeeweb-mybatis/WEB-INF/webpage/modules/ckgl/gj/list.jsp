...
<hr>
<div class="row">
    <div id="GjGridQuery" class="col-md-12">
...
<grid:grid id="Gj"
           url="${adminPath}/ckgl/gj/ajaxGjList" pageable="true">
    ...
    <grid:column label="总数量" name="zsl"/>
    <grid:column label="备注" name="bz"/>

    <grid:toolbar function="createGj" icon="fa fa-plus" btnclass="btn btn-sm btn-primary" title="添加工具"/>
...
<script type="text/javascript">
    ...
    function getFlxl() {
        ...
        $.ajax({
            type: "GET",
            url: "${adminPath}/ckgl/gj/getFlxl?fldl="+fldl,
