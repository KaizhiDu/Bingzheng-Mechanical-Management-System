        ...
        <form>
            <table class="table">
                ...
                <tr class="form-group">
                    ...
                    <td>
                        <input name="cksl" id="cksl" htmlEscape="false" class="form-control" placeholder="请输入借出数量" onchange="checkSl()"/>
                    </td>
                </tr>
...
<script type="text/javascript">
    ...
    function check() {
        ...
        $.ajax({
            type: "GET",
            url: "${adminPath}/ckgl/gj/saveGjkcck",
            data: {
                gjid: gjid,
                ly: ly,
                cksl: cksl
