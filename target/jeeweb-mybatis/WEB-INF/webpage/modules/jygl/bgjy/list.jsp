...
<div class="row">
    <div id="BgjyGridQuery" class="col-md-12">
        <div class="form-inline">
            ...
            <div class="form-group col-md-3" style="margin-bottom: 10px">
                <label class="control-label">日工/包工：</label>
                <select name="bgrg" class="form-control" id="bgrg">
                    <option value="">请选择</option>
                    <option value="日工">日工</option>
...
<script type="text/javascript">
    ...
    // 查看日工检验情况
    function ckrgjyqk(title, url, gridId, id, width, height, tipMsg) {
        url = '${adminPath}/jygl/bgjy/ckrgjyqk';
