...
<input id="gsid" name="gsid" value="${htglGs.id}" type="hidden">
<input id="yfxl" name="yfxl" value="${htglGs.yfxl}" type="hidden">
<div class="row">
    <div class="col-md-3">
        ...
        <form>
            <table class="table">
                <tr class="form-group">
                    ...
                    <td>
                        <input name="jf" id="jf" htmlEscape="false" class="form-control" placeholder="请输入甲方公司名称" value="${htglGs.jf}"/>
                    </td>
                </tr>
                <tr class="form-group">
                    <td>
...
<script type="text/javascript">
    ...
    window.onload =function() {
        var yfxl = $("#yfxl").val();
        var yfxlArray = yfxl.split(",");
        for(var i=0;i<yfxlArray.length;i++){
            $("#"+yfxlArray[i]).attr("checked",true);
        }
    }
    ...
    function check() {
        ...
        $.ajax({
            type: "GET",
            url: "${adminPath}/htglold/gs/saveUpdateGs",
            data: {
                id: id,
                jf: jf,
                yf: fin_val
