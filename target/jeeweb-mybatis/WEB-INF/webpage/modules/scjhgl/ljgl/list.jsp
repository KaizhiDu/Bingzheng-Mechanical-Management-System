...
<grid:grid id="ljgl"
    ...
    <grid:button title="导入成品库" groupname="opt" function="drcpk"
                 outclass="btn-primary" url="${adminPath}/scjhgl/ljgl/drcpk?id=\"+row.id+\"" />
...
<script type="text/javascript">
    ...
    function drcpk(title, url, gridId, id, width, height, tipMsg) {
        layer.confirm('是否要导入成品库!', {
            btn: ['确定', '取消']
