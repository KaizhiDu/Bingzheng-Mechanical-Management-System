...
<grid:grid id="Gymbxlsz"
           url="${adminPath}/scgl/gymbsz/ajaxListGymbxlsz" pageable="true">

    <grid:column label="sys.common.key" hidden="true" name="id"/>
    <grid:column label="sys.common.opt" name="opt" formatter="button" width="100"/>

    <grid:column label="工艺小类代码" name="gydldm"/>
    <grid:column label="工艺小类名称" name="gydlmc"/>
    <grid:column label="是否启用" name="sfqy" dict="SBZT" formatterValue=""/>

    <grid:toolbar function="createGydl" icon="fa fa-plus" btnclass="btn btn-sm btn-primary" title="添加工艺小类"/>
...
<script type="text/javascript">
    ...
    function Gyxl(title, url, gridId, id, width, height, tipMsg) {
        ...
        openDia("工艺小类模板",url,gridId,"1200px","800px");
    }
