    ...
    <div class="col-md-6" id="dlbzList">
        <form>
            <table class="table">
                ...
                <c:forEach items="${gyxlbzsList}" var="xlbz">
                    <tr class="form-group">
                        <td>
                            <label>${xlbz.gyxlmc}</label>
                        </td>
                        <td>
                            <input name="serachTd" id="${xlbz.id}" htmlEscape="false" class="form-control" value="${xlbz.px}" >
                        </td>
                    </tr>
                </c:forEach>
...
<script type="text/javascript">
    function check() {
        ...
        $.ajax({
            type: "GET",
            url: "${adminPath}/scgl/ljgybz/saveXlpx?list="+list,
