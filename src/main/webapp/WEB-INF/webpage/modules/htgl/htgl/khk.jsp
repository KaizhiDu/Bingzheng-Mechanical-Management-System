        ...
        <form>
            <table class="table">
                ...
                <tr class="form-group">
                    ...
                    <td>
                        <input name="hkje" id="hkje" htmlEscape="false" class="form-control" placeholder="请输入回款金额" onchange="checkHkje()"/>
                    </td>
                </tr>
                <tr class="form-group">
                    <td>
...
<script type="text/javascript">
    ...
    function check() {
        ...
        $.ajax({
            type: "GET",
            url: "${adminPath}/htgl/htgl/saveHkxq",
            data: {
                htid: htid,
                rq: rq,
                hkje: hkje,
