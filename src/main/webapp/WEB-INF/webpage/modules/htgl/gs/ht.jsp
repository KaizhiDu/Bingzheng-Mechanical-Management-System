...
<grid:grid id="Ht" url="${adminPath}/htgl/gs/ajaxHtList?id=${htglGs.id}" pageable="true">
    ...
    <grid:button title="查看详情" groupname="opt" function="ckxq"
                 outclass="btn-success" url="${adminPath}/htgl/gs/ckxq?id=\"+row.id+\"" />
    ...
    <grid:column label="合同金额" name="je"/>
    <grid:column label="备注" name="bz"/>

    <grid:toolbar function="createHt" icon="fa fa-plus" btnclass="btn btn-sm btn-primary" title="添加"/>
    <grid:toolbar function="deleteHt" icon="fa fa-trush" btnclass="btn btn-sm btn-danger" title="删除"/>
