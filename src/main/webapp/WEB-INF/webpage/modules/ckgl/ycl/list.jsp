...
<hr>
<div class="row">
    <div id="YclGridQuery" class="col-md-12">
...
<grid:grid id="Ycl"
           url="${adminPath}/ckgl/ycl/ajaxYclList" pageable="true">
    ...
    <grid:button title="入库" groupname="opt" function="rk"
                 outclass="btn-success" url="${adminPath}/ckgl/ycl/rk?id=\"+row.id+\"" />
...
<script type="text/javascript">
    ...
    function getFlxl() {
        ...
        $.ajax({
            type: "GET",
            url: "${adminPath}/ckgl/ycl/getFlxl?fldl="+fldl,
