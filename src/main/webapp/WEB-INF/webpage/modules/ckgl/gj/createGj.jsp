        ...
        <form>
            <table class="table">
                ...
                <tr class="form-group">
                    ...
                    <td>
                        <input name="gg" id="gg" htmlEscape="false" class="form-control" placeholder="请输入工具名称"/>
                    </td>
                </tr>
                <tr class="form-group">
                    <td>
                ...
                <tr class="form-group">
                    ...
                    <td>
                        <input name="zsl" id="zsl" htmlEscape="false" class="form-control" placeholder="请输入总数量" onchange="checkYjkc()"/>
                    </td>
                </tr>
                <tr class="form-group">
                    <td>
