...
<hr>
<div class="row">
    <div id="RjGridQuery" class="col-md-12">
...
<grid:grid id="Rj"
           url="${adminPath}/ckgl/rj/ajaxRjList" pageable="true">
    ...
    <grid:button title="入库" groupname="opt" function="rk"
                 outclass="btn-success" url="${adminPath}/ckgl/rj/rk?id=\"+row.id+\"" />
    <grid:button title="出库" groupname="opt" function="ck"
                 outclass="btn-primary" url="${adminPath}/ckgl/rj/ck?id=\"+row.id+\"" />
    <grid:button title="查看进销详情" groupname="opt" function="ckxq"
                 outclass="btn-warning" url="${adminPath}/ckgl/rj/ckxq?id=\"+row.id+\"" />
    <grid:button title="修改" groupname="opt" function="xg"
                 outclass="btn-info" url="${adminPath}/ckgl/rj/xg?id=\"+row.id+\"" />
    ...
    <grid:toolbar function="createRj" icon="fa fa-plus" btnclass="btn btn-sm btn-primary" title="添加刃具"/>
...
<script type="text/javascript">
    ...
    function jxxq(title, url, gridId, id, width, height, tipMsg){
        ...
        top.layer.open({
            ...
            content: "${adminPath}/ckgl/rj/jxxq",
    ...
    //添加标准件
    function createRj(title, url, gridId, id, width, height, tipMsg) {
        var url = "${adminPath}/ckgl/rj/createRj";
    ...
    function getFlxl() {
        ...
        $.ajax({
            type: "GET",
            url: "${adminPath}/ckgl/rj/getFlxl?fldl="+fldl,
