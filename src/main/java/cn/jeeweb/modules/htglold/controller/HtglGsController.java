package cn.jeeweb.modules.htglold.controller;
 ...
 */
@Controller
@RequestMapping("${admin.url.prefix}/htglold/gs")
@RequiresPathPermission("htglold:gs")
 ...
 */
    ...
    @ResponseBody
    public PageJson<HtglHtmx2> ajaxHtmxList(String id, String type, Queryable queryable, HttpServletRequest request, HttpServletResponse response, Model model){
        HtglHtmx2 htglHtmx2 = new HtglHtmx2();
        htglHtmx2.setHtid(id);
        htglHtmx2.setLx(type);
        PageJson<HtglHtmx2> pageJson = htglHtmxService.ajaxHtmxList(queryable, htglHtmx2);
        return pageJson;
    }
...
public double getNumber(String number) throws ParseException {
    ...
    public void saveFp(String htid, String bz, String rq, String fp, HttpServletRequest request, HttpServletResponse response, Model model) throws ParseException {
        ...
        htglHtmx2.setJe(fp);
        htglHtmx2.setRq2(rq);
        htglHtmx2.setRq(currentDate);
        htglHtmx2.setBz(bz);
        htglHtmx2.setLx("1");
        htglHtmx2.setHtid(htid);
        htglHtmxService.insert(htglHtmx2);
        //然后是减去合同里面的发票
        HtglHt htglHt = htglHtService.selectById(htid);
 ...
 */
    ...
    public void deleteFp(String id, String htid, HttpServletRequest request, HttpServletResponse response, Model model) throws ParseException {
        DecimalFormat df = new DecimalFormat("#,###.00");
        HtglHtmx2 htglHtmx2 = htglHtmxService.selectById(id);
